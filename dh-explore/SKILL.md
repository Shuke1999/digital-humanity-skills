---
name: dh-explore
description: Digital humanities research discovery — research question development, digital archive search, primary source criticism, corpus assembly, and literature review across humanities and computational DH traditions. Use when starting a DH project or needing to build/validate a research corpus.
---
...
|------|---------|--------------|
| `full` | `/dh-explore` or `/dh-explore full` | Complete pipeline: intake → socratic → methodology → archives → literature → corpus → synthesis → RQ |
...
2. **After intake, route by mode**:
   - `full` → Read and execute agents in order: `socratic_mentor_agent.md` → `methodology_advisor_agent.md` → `digital_archive_agent.md` → `primary_source_agent.md` → `corpus_builder_agent.md` → `humanities_literature_agent.md` → `technical_literature_agent.md` → `cross_domain_synthesis_agent.md` → `research_question_agent.md`
